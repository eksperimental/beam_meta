defmodule BeamMeta.Release.Test do
  ...
  test "is_elixir_final_release/1" do
    assert Release.is_elixir_final_release("1.13.0") == true
    assert Release.is_elixir_final_release("1.13.0-rc.0") == false
    assert Release.is_elixir_final_release("1.13.0-rc.3") == false
    assert Release.is_elixir_final_release("1.99.0") == false

    assert Release.is_elixir_final_release(Version.parse!("1.13.0")) == true
    assert Release.is_elixir_final_release(Version.parse!("1.13.0-rc.0")) == false
    assert Release.is_elixir_final_release(Version.parse!("1.13.0-rc.3")) == false
    assert Release.is_elixir_final_release(Version.parse!("1.99.0")) == false
  end
